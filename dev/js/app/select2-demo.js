define(['jquery','select2'], function($) {
    console.log('Module select-demo.init loaded.');
    function Location() {
        this.items	= {
    ...
    var _city = $('#loc_city');
    var _town = $('#loc_town');
    var _result = $("#loc_result");
    function showLocation(province , city , town) {
        var loc	= new Location();
        var title	= ['省份' , '地级市' , '市县区'];
        $.each(title , function(k,v) {
            title[k] = '<option selected value="">'+ v +'</option>';
        });
    ...
    $(function(){
        ...
        $('#btnval').on('click',function(){
            _result.val(_province.val() + ' - ' + _city.val() + ' - ' +  _town.val());
        });
        $('#btntext').on('click',function(){
            _result.val(_province.select2('data')[0].text + ' - ' + _city.select2('data')[0].text + ' - ' +  _town.select2('data')[0].text);
        });
    });
});