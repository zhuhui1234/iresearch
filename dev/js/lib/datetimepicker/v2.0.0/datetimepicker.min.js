(function (a) {
    ...
    var i = function (l, k) {
        ...
        this.icons = {
            leftArrow: this.fontAwesome ? "fa-chevron-left " : (this.bootcssVer === 3 ? "fa-chevron-left " : "icon-arrow-left"),
            rightArrow: this.fontAwesome ? "fa-chevron-right" : (this.bootcssVer === 3 ? "fa-chevron-right" : "icon-arrow-right")
        };
    ...
    var g = {
        ...
        headTemplate: '<thead><tr class="head-bg"><th class="prev"><i class="{iconType} {leftArrow}"/></th><th colspan="5" class="switch"></th><th class="next"><i class="{iconType} {rightArrow}"/></th></tr></thead>',
        headTemplateV3: '<thead><tr class="head-bg"><th class="prev"><span class="{iconType} {leftArrow}"></span> </th><th colspan="5" class="switch"></th><th class="next"><span class="{iconType} {rightArrow}"></span> </th></tr></thead>',
        contTemplate: '<tbody><tr><td colspan="7"></td></tr></tbody>',
        footTemplate: '<tfoot><tr><th colspan="7" class="today btn-primary"></th></tr><tr><th colspan="7" class="clear"></th></tr></tfoot>'
    };
