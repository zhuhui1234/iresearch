    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse">
            <div class="mobele-logo">
                <a href="//data.iresearch.com.cn/Home.shtml"><img
                            src="http://data.iresearch.com.cn/images/logo.png"></a>
            </div>
            <div class="btn-box">
            ...
            <ul class="nav navbar-nav navbar-left">
                ...
                <li id="n_2" role="presentation" class="dropdown ">
                    <a href="//data.iresearch.com.cn/iRIndex.shtml"
                       class="dropdown-toggle"><span>艾瑞指数</span><em>iRIndex</em></a>
                ...
                <li id="n_3" role="presentation" class="dropdown">
                    <a href="//data.iresearch.com.cn/iRView.shtml"
                ...
                <li id="n_4"><a href="//irv.iresearch.com.cn/iResearchDataWeb/iRCloud.shtmll"><span>艾瑞智云</span><em>iRCloud</em></a>
                </li>
                <li id="n_5" role="presentation" class="dropdown">
                    <a href="//irv.iresearch.com.cn/iResearchDataWeb/About.shtml"
                       class="dropdown-toggle"><span>关于我们</span><em>About Us</em></a>
                    <div class="dropdown-menu-box">
                        <ul class="dropdown-menu">
                            <li><a href="//irv.iresearch.com.cn/iResearchDataWeb/About.shtml"><span>联系我们</span><em>Contact
                                        Us</em></a></li>
...
<div class="footer">
    ...
    <div class="contact"><span class="ico ico1"></span>400-026-2099　　<span class="ico ico2"></span>ask@iresearch.com.cn
    </div>
    <div class="copy">
        2002 - 2017 Copyright© 艾瑞数据 <a target="_blank"
                                       href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=31010402000584"><img
                    src="http://www.iresearch.com.cn/images/record_icon.png">沪公网安备 31010402000584号</a>
    </div>
</div>
