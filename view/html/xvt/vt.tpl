...
<body>
                    ...
                    <li id="n_2" role="presentation" class="dropdown ">
                        ...
                        <div class="dropdown-menu-box">
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="http://index.iresearch.com.cn/pc"><i class="icon icon-pc"></i><span>PC 指数</span><em>Web User Behavior Insight</em></a></li>
                                <li><a href="http://index.iresearch.com.cn/Video/"><i class="icon icon-video"></i><span>影视 指数</span><em>Network Video Market Monitoring</em></a></li>
                            </ul>
                        </div>
                    </li>
                    <li id="n_3" role="presentation" class="dropdown">
                        ...
                        <div class="dropdown-menu-box">
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="http://irv.iresearch.com.cn/iResearchDataWeb/?m=user&a=jump&pro=18" target="_blank"><i class="icon icon-iRView-2"></i><em>mVideoTracker</em><span>移动视频内容市场监测</span></a></li>
                                <li><a href="http://irv.iresearch.com.cn/iResearchDataWeb/?m=user&a=jump&pro=19" target="_blank"><i class="icon icon-iRView-3"></i><em>oVideoTracker</em><span>OTT视频内容市场监测</span></a></li>
                                ...
                                <li><a href="http://irv.iresearch.com.cn/iResearchDataWeb/?m=user&a=jump&pro=12" target="_blank"><i class="icon icon-iRView-5"></i><em>iUserTracker</em><span>PC端用户行为监测</span></a></li>
                                <li><a href="http://irv.iresearch.com.cn/iResearchDataWeb/?m=user&a=jump&pro=37" target="_blank"><i class="icon icon-iRView-6"></i><em>mUserTracker</em><span>移动端用户行为监测</span></a></li>
        ...
        <div class="mobile">
            <div class="item vt" v-for="item in product" :key="item">
                ...
                <div class="change-btn" >
                    ...
                    <button v-if="product[tabIndex].oldurl !== '' " class="btn btn-link" data-toggle="modal" data-target="#myModal">切换旧版本</button>

                    <!-- ELSE -->

                    <a v-if="product[tabIndex].oldurl !== '' " class="btn btn-link" v-bind:href="[[ product[tabIndex].oldurl ]]">切换旧版本</a>
    ...
    <script>
        var product = [{
            ...
            oldUrl: '',
            info: 'mVideoTracker移动端视频市场监测，基于运营商级别的用户观看移动网络视频内容的收视行为数据，监测主流视频内容提供商不同频道、类型和产地的收视情况，洞察视频内容在不同视频内容提供商的收视差异及行业收视热度，分析不同受众人群观看视频内容的偏好程度，监控视频内容在各时段的收视趋势，为视频广告媒介优化、视频内容竞争分析、视频内容制作及投资价值，提供客观、准确、快速的第三方监测分析数据。',
            itemA: {
                title: '视频内容提供商',
                info: [
