        ...
        <div class="mobile">
            <div class="item ut" v-for="item in product">
                ...
                <div class="change-btn">
                    ...
                    <!-- IF token=="1" -->
                    <a class="btn btn-lg btn-primary" v-bind:href="[[ product[tabIndex].oldurl ]]">切换旧版本</a>
                    <!-- ELSE -->
                    <!-- IF irdStatus=="1" -->

                    <button v-if="product[tabIndex].isOldURL " class="btn btn-lg btn-primary" data-toggle="modal" data-target="#myModal">切换旧版本</button>
                    <!-- ELSE -->

                    <a v-if="product[tabIndex].isOldURL" class="btn btn-lg btn-primary" v-bind:href="[[ product[tabIndex].oldurl ]]">切换旧版本</a>
            ...
            <div class="item-tab">
                ...
                <div class="item-tab-content">
                    ...
                    <div class="change-btn">
                        ...
                        <!-- IF token=="1" -->
                        <a v-if="product[tabIndex].show" class="btn btn-lg btn-primary" v-bind:href="[[ product[tabIndex].oldurl ]]">切换旧版本</a>
                        <!-- ELSE -->
                        <!-- IF irdStatus=="1" -->

                        <button v-if="product[tabIndex].isOldURL && product[tabIndex].show" class="btn btn-lg btn-primary" data-toggle="modal" data-target="#myModal">切换旧版本</button>
                        <!-- ELSE -->

                        <a v-if="product[tabIndex].isOldURL && product[tabIndex].show" class="btn btn-lg btn-primary" v-bind:href="[[ product[tabIndex].oldurl ]]">切换旧版本</a>
